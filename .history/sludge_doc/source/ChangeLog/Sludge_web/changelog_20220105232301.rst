...
- Added
  ...
  - Add Selection input in BioModel Detail.
    ...
    - You could select a standard parameter or component or just type a symbol whaterev you want.
    - Once you select a standard parameter or component symbol, the rest field(such as unit and name) will fill automatically.
