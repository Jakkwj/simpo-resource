...
=============
There are a few ways to create a DataSet (choose 1 from 5 ways in below), after creation you can  release different version to reference it while creating a Project:
