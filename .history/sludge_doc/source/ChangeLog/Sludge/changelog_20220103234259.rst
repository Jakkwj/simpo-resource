...
- Changed
  ...
  - The motive of calculation.detection_limit(1.0e-30) has changed:

    - detection_limit now forces the biocomponent to it while biocomponent less than it
    - for instant, if biocomponent(1) < 1.0e-30, then biocomponent(1) = 1.0e-30
