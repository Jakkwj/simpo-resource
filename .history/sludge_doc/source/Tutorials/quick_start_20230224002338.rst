...
Super!
--------------
Clone a Project from the public Project repository is a easy way to create a project, and this will also clone the correspoding BioModel and Dataset, you can
