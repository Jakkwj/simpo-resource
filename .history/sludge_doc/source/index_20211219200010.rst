...
The Unit column in Parameter sheet of **BioModel.xlsx** is actually an annotation, it won't affect any calcualtion result. So you should know the kinetics parameter time unit will always be ``'day'``.
