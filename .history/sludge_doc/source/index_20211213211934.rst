...
Let's Build Models Together</i></p>
			...
			The biological model was written in the form of xlsx file(in the BioModelMatrix folder). By this way, one can check and make his own biological model conveniently.</p>
