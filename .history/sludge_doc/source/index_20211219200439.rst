...
The Unit column in Parameter sheet of **BioModel.xlsx** is actually an annotation, it won't affect any calcualtion result.
For instant, ``b_OHO_end`` (the endogenous respiration rate coefficient of ordinary heterotrophic organisms) will always be ``'day'``
