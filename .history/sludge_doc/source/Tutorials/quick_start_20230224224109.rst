...
.. admonition:: *Layout Flow Chart*
  ...
  *Layout flow chart will be generated automatically after adding links (inflows, flows and connections). You can click and edit the tank, inflow and flow in the chart.*
