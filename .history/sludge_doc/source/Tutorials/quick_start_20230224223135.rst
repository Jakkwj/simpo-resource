...
.. admonition:: *Note*
 :class: note
  ...
  - *The layout flow chart will be generated automatically after adding some links (inflows/flows/connections). You can click and edit the tank, inflow and flow in the chart.*
