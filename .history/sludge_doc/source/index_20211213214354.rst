...
Sludge is a **SaaS platform** for calculating the matrix like biochemical models (such as activated sludge models 1, 2 and 3).
The aim of this project is to help people to build and calculate their own wasterwater treatment process easily.
The input of the whole peocess are only 3 xlsx files. By this way, one can check and make his own biological model conveniently.



The key features are:

- Simple: only 3 excel files and you are good to go.
- Shareable
- Trackable
