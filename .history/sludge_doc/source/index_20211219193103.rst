...
Time Unit
==============
During calcualting, there are 3 time units: **sample rate**, **measured** and **parameter**.
Parameter time unit is setted to be 'day' and unchangable.
So the Unit column in Parameter sheet of BioModel.xlsx is actually an annotation, it will affect the calcualte result.
