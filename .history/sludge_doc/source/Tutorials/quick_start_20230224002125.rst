...
--------------
Clone a Project from public Project repository.

Actually this will also clone the correspoding BioModel and Dataset,
...
3. Clone a Project from public Project repository.
