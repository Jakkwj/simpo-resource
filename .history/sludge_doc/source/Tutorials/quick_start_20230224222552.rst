...
=============
There are a few ways to create a DataSet (choose 1 from 5 ways in below), after creation you can  release different versions to reference it while creating a Project:
...
.. admonition:: *Note*
 :class: note
  ...
  - *After adding some links (inflows/flows/connections), the layout flow chart will be generated automatically. You can click and edit the tank, inflow and flow in the layout flow chart.*
  - *Before finished the editing of the detial, temparary save can avoid lost the input.*
  - *After finished the  editing, parsed save it to make sure all the input formats are correct.*
