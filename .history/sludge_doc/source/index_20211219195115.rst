...
Time Unit
==============
During calcualting, there are 2 time units we should notice: **Parameter** and **Measured**. And all time units will translated to **`second`** to unify the time unit for whole calcualtion.
